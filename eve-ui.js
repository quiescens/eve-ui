...
(function (eveui) {
    ...
    $(document).on('click', '.eveui_more_icon', function (e) {
        ...
        var eveui_itemselect = $("<span class=\"eveui_itemselect\" style=\"position:absolute\"><input type=\"text\" list=\"eveui_itemselect\" placeholder=\"" + $(this).closest('[data-eveui-itemid]').find('.eveui_rowcontent').text() + "\" /><datalist id=\"eveui_itemselect\" /></span>");
    ...
    function format_fit(dna, eveui_name) {
        ...
        function item_rows(fittings, slots_available) {
            ...
            for (var item_id in fittings) {
                ...
                html += "<tr class=\"nocopy\" data-eveui-itemid=\"" + item_id + "\"><td><img src=\"https://imageserver.eveonline.com/Type/" + item_id + "_32.png\" class=\"eveui_icon eveui_item_icon\" /><td class=\"eveui_right\">" + fittings[item_id] + "<td colspan=\"2\"><div class=\"eveui_rowcontent\">" + item.name + "</div><td class=\"eveui_right whitespace_nowrap\"><span data-itemid=\"" + item_id + "\" class=\"eveui_icon eveui_info_icon\" /><span class=\"eveui_icon eveui_plus_icon eveui_edit\" /><span class=\"eveui_icon eveui_minus_icon eveui_edit\" /><span class=\"eveui_icon eveui_more_icon eveui_edit\" />";
            }
        ...
        var html = "<table><thead><tr class=\"eveui_fit_header\" data-eveui-itemid=\"" + ship_id + "\"><td colspan=\"2\"><img src=\"https://imageserver.eveonline.com/Type/" + ship_id + "_32.png\" class=\"eveui_icon eveui_ship_icon\" /><td><div class=\"eveui_rowcontent\"><span class=\"eveui_startcopy\" />[<a target=\"_blank\" href=\"" + eveui_urlify(dna) + "\">" + ship.name + ", " + (eveui_name || ship.name) + "</a>]<br/></div><td class=\"eveui_right whitespace_nowrap nocopy\" colspan=\"2\">" + (eveui_allow_edit ? '<span class="eveui_icon eveui_edit_icon" />' : '') + "<span class=\"eveui_icon eveui_copy_icon\" /><span data-itemid=\"" + ship_id + "\" class=\"eveui_icon eveui_info_icon\" /><span class=\"eveui_icon eveui_edit\" /><span class=\"eveui_icon eveui_edit\" /><span class=\"eveui_icon eveui_more_icon eveui_edit\" /></thead><tbody class=\"whitespace_nowrap\">" + item_rows(high_slots, ship.hiSlots) + "<tr><td class=\"eveui_line_spacer\">&nbsp;" + item_rows(med_slots, ship.medSlots) + "<tr><td class=\"eveui_line_spacer\">&nbsp;" + item_rows(low_slots, ship.lowSlots) + "<tr><td class=\"eveui_line_spacer\">&nbsp;" + item_rows(rig_slots, ship.rigSlots) + "<tr><td class=\"eveui_line_spacer\">&nbsp;" + item_rows(subsystem_slots, ship.maxSubSystems) + "<tr><td class=\"eveui_line_spacer\">&nbsp;" + item_rows(other_slots) + "</tbody></table><span class=\"eveui_endcopy\" />";
        return html;
    }
    ...
    function format_char(char_id) {
        ...
        var html = "<table><tr><td colspan=\"2\"><img class=\"float_left\" src=\"https://imageserver.eveonline.com/Character/" + character.id + "_128.jpg\" height=\"128\" width=\"128\" />" + character.name + "<hr /><img class=\"float_left\" src=\"https://imageserver.eveonline.com/Corporation/" + character.corporation.id_str + "_64.png\" height=\"64\" width=\"64\" />Member of " + character.corporation.name + "<tr><td>Bio:<td>" + character.description.replace(/<font[^>]+>/g, '<font>') + "</table>";
        return html;
    }
